...
TX2_OUTPUT=$(near contract call-function as-transaction \
  ...
  json-args '{
    ...
    "input_data": "{\"prompt\":\"What could the NEAR offshore project do? Be short\",\"history\":[{\"role\":\"user\",\"content\":\"Tell me about NEAR\"},{\"role\":\"assistant\",\"content\":\"NEAR is a Layer 1 blockchain...\"}],\"model_name\":\"fireworks::accounts/fireworks/models/deepseek-v3\",\"openai_endpoint\":\"https://api.near.ai/v1/chat/completions\",\"max_tokens\":16384}",
