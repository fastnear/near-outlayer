...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:near:rpc@0.1.0:rpc-test:encoded world"
)]
#[doc(hidden)]
...
params-jsons\0\0\x04\0\x03raw\x01\x0f\x03\0\x12near:rpc/api@0.1.0\x05\0\x04\0\x17\
near:rpc/rpc-test@0.1.0\x04\0\x0b\x0e\x01\0\x08rpc-test\x03\0\0\0G\x09producers\x01\
